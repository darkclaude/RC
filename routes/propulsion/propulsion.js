...
var thrust1     = $.gauge('#thrust1', { size: size,ul:100,q1:0.1,q2:0.6,q3:0.8, footer:"Percent", title:"Engine 1",inv: true});  
var thrust2     = $.gauge('#thrust2', { size: size,ul:100,q1:0.1,q2:0.6,q3:0.8, footer:"Percent", title:"Engine 2",inv: true});  
...
$scope.btnC= "btn btn-danger";
  ...
  //  $scope.conStatus=true;
     ...
     try{
        ...
        thrust1.setValue(data.engine1);
        thrust2.setValue(data.engine2);
